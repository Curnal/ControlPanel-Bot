...
exports.run = async (client, message, args, guildConf, userConf) => {
    ...
    request.get(`${panel}/api/application/users/${panelID}?include=servers`, {
        ...
        client.userDB.set(`${discordUser.id}-${message.guild.id}`, data, "panel.data");
        client.userDB.set(`${discordUser.id}-${message.guild.id}`, servers, "panel.servers");
        client.userDB.set(`${discordUser.id}-${message.guild.id}`, null, "panel.focused");
